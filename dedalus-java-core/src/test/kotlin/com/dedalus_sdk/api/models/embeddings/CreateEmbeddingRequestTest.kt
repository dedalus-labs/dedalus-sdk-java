...
internal class CreateEmbeddingRequestTest {
    ...
    fun create() {
        ...
        assertThat(createEmbeddingRequest.dimensions()).contains(1L)
        assertThat(createEmbeddingRequest.encodingFormat())
            .contains(CreateEmbeddingRequest.EncodingFormat.FLOAT)
        assertThat(createEmbeddingRequest.user()).contains("user")
    }
