...
internal class ModelTest {
    ...
    fun create() {
        ...
        assertThat(model.description()).contains("description")
        assertThat(model.displayName()).contains("display_name")
        assertThat(model.providerDeclaredGenerationMethods().getOrNull()).containsExactly("string")
        ...
        assertThat(model.version()).contains("version")
    }
