...
internal class ChatCompletionCreateParamsTest {
    ...
    fun create() {
        ...
        assertThat(chatCompletionCreateParams.automaticToolExecution()).contains(true)
        assertThat(chatCompletionCreateParams.cachedContent()).contains("cached_content")
        assertThat(chatCompletionCreateParams.correlationId()).contains("correlation_id")
        ...
        assertThat(chatCompletionCreateParams.deferred()).contains(true)
        assertThat(chatCompletionCreateParams.deferredCalls().getOrNull())
            .containsExactly(
                DeferredCallResponse.builder()
                    .id("id")
                    .name("name")
        ...
        assertThat(chatCompletionCreateParams.frequencyPenalty()).contains(-2.0)
        assertThat(chatCompletionCreateParams.functionCall()).contains("function_call")
        assertThat(chatCompletionCreateParams.functions().getOrNull())
            .containsExactly(
                ChatCompletionFunctions.builder()
                    .name("name")
                    .description("description")
        ...
        assertThat(chatCompletionCreateParams.guardrails().getOrNull())
            .containsExactly(
                ChatCompletionCreateParams.Guardrail.builder()
                    .putAdditionalProperty("foo", JsonValue.from("bar"))
                    .build()
        ...
        assertThat(chatCompletionCreateParams.handoffMode()).contains(true)
        assertThat(chatCompletionCreateParams.inferenceGeo()).contains("inference_geo")
        ...
        assertThat(chatCompletionCreateParams.logprobs()).contains(true)
        assertThat(chatCompletionCreateParams.maxCompletionTokens()).contains(0L)
        assertThat(chatCompletionCreateParams.maxTokens()).contains(1L)
        assertThat(chatCompletionCreateParams.maxTurns()).contains(5L)
        assertThat(chatCompletionCreateParams.mcpServers())
            .contains(ChatCompletionCreateParams.McpServers.ofString("dedalus-labs/example-server"))
        assertThat(chatCompletionCreateParams.messages().getOrNull())
            .containsExactly(
        ...
        assertThat(chatCompletionCreateParams.modalities().getOrNull()).containsExactly("string")
        ...
        assertThat(chatCompletionCreateParams.n()).contains(1L)
        ...
        assertThat(chatCompletionCreateParams.parallelToolCalls()).contains(true)
        assertThat(chatCompletionCreateParams.prediction())
            .contains(PredictionContent.builder().content("string").build())
        assertThat(chatCompletionCreateParams.presencePenalty()).contains(-2.0)
        assertThat(chatCompletionCreateParams.promptCacheKey()).contains("prompt_cache_key")
        ...
        assertThat(chatCompletionCreateParams.promptMode())
            .contains(ChatCompletionCreateParams.PromptMode.REASONING)
        assertThat(chatCompletionCreateParams.reasoningEffort()).contains("reasoning_effort")
        ...
        assertThat(chatCompletionCreateParams.safePrompt()).contains(true)
        assertThat(chatCompletionCreateParams.safetyIdentifier()).contains("safety_identifier")
        assertThat(chatCompletionCreateParams.safetySettings().getOrNull())
            .containsExactly(
                ChatCompletionCreateParams.SafetySetting.builder()
                    .category(
        ...
        assertThat(chatCompletionCreateParams.seed()).contains(0L)
        assertThat(chatCompletionCreateParams.serviceTier()).contains("service_tier")
        assertThat(chatCompletionCreateParams.speed())
            .contains(ChatCompletionCreateParams.Speed.STANDARD)
        assertThat(chatCompletionCreateParams.stop())
            .contains(ChatCompletionCreateParams.Stop.ofStrings(listOf("string")))
        assertThat(chatCompletionCreateParams.store()).contains(true)
        assertThat(chatCompletionCreateParams.stream()).contains(true)
        ...
        assertThat(chatCompletionCreateParams.temperature()).contains(0.0)
        ...
        assertThat(chatCompletionCreateParams.toolChoice())
            .contains(ChatCompletionCreateParams.ToolChoice.ofString("string"))
        ...
        assertThat(chatCompletionCreateParams.tools().getOrNull())
            .containsExactly(
                ChatCompletionToolParam.builder()
                    .function(FunctionDefinition.builder().name("name").build())
                    .type(ChatCompletionToolParam.Type.FUNCTION)
        ...
        assertThat(chatCompletionCreateParams.topK()).contains(0L)
        assertThat(chatCompletionCreateParams.topLogprobs()).contains(0L)
        assertThat(chatCompletionCreateParams.topP()).contains(0.0)
        assertThat(chatCompletionCreateParams.user()).contains("user")
        assertThat(chatCompletionCreateParams.verbosity()).contains("verbosity")
