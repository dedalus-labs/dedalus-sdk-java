...
internal class ToolChoiceTest {
    ...
    fun ofUnionMember0() {
        ...
        assertThat(toolChoice.unionMember0()).contains(unionMember0)
        assertThat(toolChoice.string()).isEmpty
        assertThat(toolChoice.unionMember2()).isEmpty
        assertThat(toolChoice.mcp()).isEmpty
    }
    ...
    fun ofString() {
        ...
        assertThat(toolChoice.unionMember0()).isEmpty
        assertThat(toolChoice.string()).contains(string)
        assertThat(toolChoice.unionMember2()).isEmpty
        assertThat(toolChoice.mcp()).isEmpty
    }
    ...
    fun ofUnionMember2() {
        ...
        assertThat(toolChoice.unionMember0()).isEmpty
        assertThat(toolChoice.string()).isEmpty
        assertThat(toolChoice.unionMember2()).contains(unionMember2)
        assertThat(toolChoice.mcp()).isEmpty
    }
    ...
    fun ofMcp() {
        ...
        assertThat(toolChoice.string()).isEmpty
        assertThat(toolChoice.unionMember2()).isEmpty
        assertThat(toolChoice.mcp()).contains(mcp)
    }
