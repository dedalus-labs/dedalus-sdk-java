...
internal class DedalusModelChoiceTest {
    ...
    fun ofModelId() {
        ...
        assertThat(dedalusModelChoice.modelId()).contains(modelId)
        assertThat(dedalusModelChoice.dedalusModel()).isEmpty
    }
    ...
    fun ofDedalusModel() {
        ...
        assertThat(dedalusModelChoice.modelId()).isEmpty
        assertThat(dedalusModelChoice.dedalusModel()).contains(dedalusModel)
    }
