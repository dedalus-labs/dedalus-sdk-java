...
internal class ChatCompletionTest {
    ...
    fun create() {
        ...
        assertThat(chatCompletion.correlationId()).contains("correlation_id")
        assertThat(chatCompletion.deferred().getOrNull())
            .containsExactly(
                DeferredCallResponse.builder()
                    .id("id")
                    .name("name")
        ...
        assertThat(chatCompletion.mcpToolResults().getOrNull())
            .containsExactly(
                McpToolResult.builder()
                    .arguments(
                        JsonObjectInput.builder()
        ...
        assertThat(chatCompletion.pendingTools().getOrNull())
            .containsExactly(
                ChatCompletion.PendingTool.builder()
                    .id("id")
                    .arguments(
        ...
        assertThat(chatCompletion.toolsExecuted().getOrNull())
            .containsExactly("search_events", "get_event_details")
        assertThat(chatCompletion.turnsConsumed()).contains(0L)
