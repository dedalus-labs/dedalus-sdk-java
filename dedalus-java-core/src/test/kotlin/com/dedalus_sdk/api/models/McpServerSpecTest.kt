...
internal class McpServerSpecTest {
    ...
    fun create() {
        ...
        assertThat(mcpServerSpec.slug()).contains("_1K--W2kIFj1/_-Mtu--_-p")
        assertThat(mcpServerSpec.url()).contains("url")
        assertThat(mcpServerSpec.version()).contains("version")
    }
