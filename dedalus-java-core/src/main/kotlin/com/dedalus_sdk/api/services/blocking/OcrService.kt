...
interface OcrService {
     ...
     */
    fun process(params: OcrProcessParams): OcrResponse = process(params, RequestOptions.none())
    ...
    /** @see process */
    fun process(ocrRequest: OcrRequest): OcrResponse = process(ocrRequest, RequestOptions.none())
    ...
    interface WithRawResponse {
         ...
         */
        @MustBeClosed
        fun process(params: OcrProcessParams): HttpResponseFor<OcrResponse> =
        ...
        /** @see process */
        @MustBeClosed
        fun process(ocrRequest: OcrRequest): HttpResponseFor<OcrResponse> =
