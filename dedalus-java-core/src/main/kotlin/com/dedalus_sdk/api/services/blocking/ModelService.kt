...
interface ModelService {
     ...
     *     ```
     */
    fun retrieve(modelId: String): Model = retrieve(modelId, ModelRetrieveParams.none())
    ...
    /** @see retrieve */
    fun retrieve(modelId: String, params: ModelRetrieveParams = ModelRetrieveParams.none()): Model =
     ...
     */
    fun list(): ListModelsResponse = list(ModelListParams.none())
    ...
    /** @see list */
    fun list(params: ModelListParams = ModelListParams.none()): ListModelsResponse =
    ...
    interface WithRawResponse {
         ...
         */
        @MustBeClosed
        fun retrieve(modelId: String): HttpResponseFor<Model> =
        ...
        fun retrieve(
            modelId: String,
            params: ModelRetrieveParams = ModelRetrieveParams.none(),
        ): HttpResponseFor<Model> = retrieve(modelId, params, RequestOptions.none())
         ...
         * [ModelService.list].
         */
        @MustBeClosed fun list(): HttpResponseFor<ListModelsResponse> = list(ModelListParams.none())
        ...
        fun list(
            params: ModelListParams = ModelListParams.none()
        ): HttpResponseFor<ListModelsResponse> = list(params, RequestOptions.none())
