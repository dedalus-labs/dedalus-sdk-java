...
interface CompletionService {
     ...
     */
    fun create(params: CompletionCreateParams): ChatCompletion =
    ...
    /** @see create */
    fun create(chatCompletionCreateParams: ChatCompletionCreateParams): ChatCompletion =
     ...
     */
    @MustBeClosed
    fun createStreaming(params: CompletionCreateParams): StreamResponse<ChatCompletionChunk> =
    ...
    interface WithRawResponse {
         ...
         */
        @MustBeClosed
        fun create(params: CompletionCreateParams): HttpResponseFor<ChatCompletion> =
            create(params, RequestOptions.none())
