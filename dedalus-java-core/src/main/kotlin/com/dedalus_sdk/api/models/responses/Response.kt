...
private constructor(
     ...
     *   server responded with an unexpected value).
     */
    fun conversation(): Optional<JsonObjectInput> = conversation.getOptional("conversation")
     ...
     *   server responded with an unexpected value).
     */
    fun error(): Optional<JsonObjectInput> = error.getOptional("error")
     ...
     *   server responded with an unexpected value).
     */
    fun mcpServerErrors(): Optional<McpServerErrors> =
        mcpServerErrors.getOptional("mcp_server_errors")
     ...
     *   server responded with an unexpected value).
     */
    fun mcpToolResults(): Optional<List<McpToolResult>> =
        mcpToolResults.getOptional("mcp_tool_results")
     ...
     *   server responded with an unexpected value).
     */
    fun outputText(): Optional<String> = outputText.getOptional("output_text")
     ...
     *   server responded with an unexpected value).
     */
    fun reasoning(): Optional<JsonObjectInput> = reasoning.getOptional("reasoning")
     ...
     *   server responded with an unexpected value).
     */
    fun text(): Optional<JsonObjectInput> = text.getOptional("text")
     ...
     *   server responded with an unexpected value).
     */
    fun tools(): Optional<List<JsonObjectInput>> = tools.getOptional("tools")
     ...
     *   server responded with an unexpected value).
     */
    fun toolsExecuted(): Optional<List<String>> = toolsExecuted.getOptional("tools_executed")
     ...
     *   server responded with an unexpected value).
     */
    fun truncation(): Optional<String> = truncation.getOptional("truncation")
     ...
     *   server responded with an unexpected value).
     */
    fun usage(): Optional<JsonObjectInput> = usage.getOptional("usage")
    ...
    class Builder internal constructor() {
        ...
        fun conversation(conversation: Optional<JsonObjectInput>) =
        ...
        fun error(error: Optional<JsonObjectInput>) = error(error.getOrNull())
        ...
        /** Alias for calling [Builder.mcpServerErrors] with `mcpServerErrors.orElse(null)`. */
        fun mcpServerErrors(mcpServerErrors: Optional<McpServerErrors>) =
            mcpServerErrors(mcpServerErrors.getOrNull())
        ...
        /** Alias for calling [Builder.mcpToolResults] with `mcpToolResults.orElse(null)`. */
        fun mcpToolResults(mcpToolResults: Optional<List<McpToolResult>>) =
            mcpToolResults(mcpToolResults.getOrNull())
        ...
        /** Alias for calling [Builder.outputText] with `outputText.orElse(null)`. */
        fun outputText(outputText: Optional<String>) = outputText(outputText.getOrNull())
        ...
        fun reasoning(reasoning: Optional<JsonObjectInput>) = reasoning(reasoning.getOrNull())
        ...
        fun text(text: Optional<JsonObjectInput>) = text(text.getOrNull())
        ...
        fun tools(tools: Optional<List<JsonObjectInput>>) = tools(tools.getOrNull())
        ...
        /** Alias for calling [Builder.toolsExecuted] with `toolsExecuted.orElse(null)`. */
        fun toolsExecuted(toolsExecuted: Optional<List<String>>) =
            toolsExecuted(toolsExecuted.getOrNull())
        ...
        fun truncation(truncation: Optional<String>) = truncation(truncation.getOrNull())
        ...
        fun usage(usage: Optional<JsonObjectInput>) = usage(usage.getOrNull())
    ...
    fun validate(): Response = apply {
        ...
        maxOutputTokens()
        maxToolCalls()
        mcpServerErrors().ifPresent { it.validate() }
        mcpToolResults().ifPresent { it.forEach { it.validate() } }
    ...
    internal fun validity(): Int =
        (if (id.asKnown().isPresent) 1 else 0) +
            ...
            (mcpServerErrors.asKnown().getOrNull()?.validity() ?: 0) +
            (mcpToolResults.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) +
            (metadata.asKnown().getOrNull()?.validity() ?: 0) +
            (object_.asKnown().getOrNull()?.validity() ?: 0) +
            (if (outputText.asKnown().isPresent) 1 else 0) +
            ...
            (toolsExecuted.asKnown().getOrNull()?.size ?: 0) +
            (if (topLogprobs.asKnown().isPresent) 1 else 0) +
            (if (topP.asKnown().isPresent) 1 else 0) +
            (if (truncation.asKnown().isPresent) 1 else 0) +
    ...
    private constructor(
        ...
        fun jsonObjectInputs(): Optional<List<JsonObjectInput>> =
            Optional.ofNullable(jsonObjectInputs)
