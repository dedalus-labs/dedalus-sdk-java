...
private constructor(
    ...
    /** A builder for [ChatCompletionContentPartInputAudioParam]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            inputAudio = chatCompletionContentPartInputAudioParam.inputAudio
            type = chatCompletionContentPartInputAudioParam.type
            additionalProperties =
                chatCompletionContentPartInputAudioParam.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ChatCompletionContentPartInputAudioParam].
         *
         ...
         */
        fun build(): ChatCompletionContentPartInputAudioParam =
            ChatCompletionContentPartInputAudioParam(
     ...
     *   expected type.
     */
    fun validate(): ChatCompletionContentPartInputAudioParam = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ChatCompletionContentPartInputAudioParam &&
    ...
    override fun toString() =
        "ChatCompletionContentPartInputAudioParam{inputAudio=$inputAudio, type=$type, additionalProperties=$additionalProperties}"
}
