...
private constructor(
     ...
     * - usage (optional): TranscriptTextUsageDuration
     */
    fun createTranscriptionResponseVerboseJson(): Optional<CreateTranscriptionResponseVerboseJson> =
        Optional.ofNullable(createTranscriptionResponseVerboseJson)
     ...
     */
    fun createTranscriptionResponseJson(): Optional<CreateTranscriptionResponseJson> =
        Optional.ofNullable(createTranscriptionResponseJson)
     ...
     * import java.util.Optional;
     *
     * Optional<String> result = transcriptionCreateResponse.accept(new TranscriptionCreateResponse.Visitor<Optional<String>>() {
     *     @Override
     *     public Optional<String> visitCreateTranscriptionResponseVerboseJson(CreateTranscriptionResponseVerboseJson createTranscriptionResponseVerboseJson) {
     *         return Optional.of(createTranscriptionResponseVerboseJson.toString());
     *     }
     *
     *     // ...
     *
    ...
    private constructor(
        ...
        private constructor(
             ...
             * import java.util.Optional;
             *
             * Optional<String> result = usage.accept(new Usage.Visitor<Optional<String>>() {
             *     @Override
             *     public Optional<String> visitTokens(Tokens tokens) {
             *         return Optional.of(tokens.toString());
             *     }
             *
             *     // ...
             *
