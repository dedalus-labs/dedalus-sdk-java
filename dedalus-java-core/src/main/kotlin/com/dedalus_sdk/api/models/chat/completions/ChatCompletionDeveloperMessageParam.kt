...
private constructor(
    ...
    class Builder internal constructor() {
         ...
         * `Content.ofChatCompletionRequestDeveloperMessageContentArray(chatCompletionRequestDeveloperMessageContentArray)`.
         */
        fun contentOfChatCompletionRequestDeveloperMessageContentArray(
            chatCompletionRequestDeveloperMessageContentArray:
                List<ChatCompletionContentPartTextParam>
        ) =
            content(
                Content.ofChatCompletionRequestDeveloperMessageContentArray(
                    chatCompletionRequestDeveloperMessageContentArray
                )
            )
    ...
    private constructor(
        ...
        private val chatCompletionRequestDeveloperMessageContentArray:
            List<ChatCompletionContentPartTextParam>? =
            null,
        ...
        fun chatCompletionRequestDeveloperMessageContentArray():
            Optional<List<ChatCompletionContentPartTextParam>> =
            Optional.ofNullable(chatCompletionRequestDeveloperMessageContentArray)

        fun isString(): Boolean = string != null

        fun isChatCompletionRequestDeveloperMessageContentArray(): Boolean =
            chatCompletionRequestDeveloperMessageContentArray != null

        fun asString(): String = string.getOrThrow("string")

        fun asChatCompletionRequestDeveloperMessageContentArray():
            List<ChatCompletionContentPartTextParam> =
            chatCompletionRequestDeveloperMessageContentArray.getOrThrow(
                "chatCompletionRequestDeveloperMessageContentArray"
            )
        ...
        fun <T> accept(visitor: Visitor<T>): T =
            when {
                ...
                chatCompletionRequestDeveloperMessageContentArray != null ->
                    visitor.visitChatCompletionRequestDeveloperMessageContentArray(
                        chatCompletionRequestDeveloperMessageContentArray
                    )
        ...
        fun validate(): Content = apply {
            ...
            accept(
                object : Visitor<Unit> {
                    ...
                    override fun visitChatCompletionRequestDeveloperMessageContentArray(
                        chatCompletionRequestDeveloperMessageContentArray:
                            List<ChatCompletionContentPartTextParam>
                    ) {
                        chatCompletionRequestDeveloperMessageContentArray.forEach { it.validate() }
                    }
                }
            )
            validated = true
            ...
            accept(
                object : Visitor<Int> {
                    ...
                    override fun visitChatCompletionRequestDeveloperMessageContentArray(
                        ...
                        chatCompletionRequestDeveloperMessageContentArray.sumOf {
                            it.validity().toInt()
                        }
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return other is Content &&
                string == other.string &&
                chatCompletionRequestDeveloperMessageContentArray ==
                    other.chatCompletionRequestDeveloperMessageContentArray
        }

        override fun hashCode(): Int =
            Objects.hash(string, chatCompletionRequestDeveloperMessageContentArray)

        override fun toString(): String =
            when {
                string != null -> "Content{string=$string}"
                chatCompletionRequestDeveloperMessageContentArray != null ->
                    "Content{chatCompletionRequestDeveloperMessageContentArray=$chatCompletionRequestDeveloperMessageContentArray}"
        ...
        companion object {
            ...
            @JvmStatic
            fun ofChatCompletionRequestDeveloperMessageContentArray(
                chatCompletionRequestDeveloperMessageContentArray:
                    List<ChatCompletionContentPartTextParam>
            ) =
                Content(
                    chatCompletionRequestDeveloperMessageContentArray =
                        chatCompletionRequestDeveloperMessageContentArray.toImmutable()
                )
        }
        ...
        interface Visitor<out T> {
            ...
            fun visitChatCompletionRequestDeveloperMessageContentArray(
                chatCompletionRequestDeveloperMessageContentArray:
                    List<ChatCompletionContentPartTextParam>
            ): T
                ...
                val bestMatches =
                    sequenceOf(
                            ...
                            tryDeserialize(
                                ...
                                ?.let {
                                    Content(
                                        chatCompletionRequestDeveloperMessageContentArray = it,
                                        _json = json,
                                    )
                                },
                        )
        ...
        internal class Serializer : BaseSerializer<Content>(Content::class) {
            ...
            override fun serialize(
                ...
                when {
                    ...
                    value.chatCompletionRequestDeveloperMessageContentArray != null ->
                        generator.writeObject(
                            value.chatCompletionRequestDeveloperMessageContentArray
                        )
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ChatCompletionDeveloperMessageParam &&
