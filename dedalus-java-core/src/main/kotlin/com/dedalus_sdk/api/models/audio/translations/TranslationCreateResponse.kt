...
private constructor(
     ...
     * - segments (optional): list[TranscriptionSegment]
     */
    fun createTranslationResponseVerboseJson(): Optional<CreateTranslationResponseVerboseJson> =
        Optional.ofNullable(createTranslationResponseVerboseJson)

    /**
     * Fields: # noqa: D415.
     * - text (required): str
     */
    fun createTranslationResponseJson(): Optional<CreateTranslationResponseJson> =
        Optional.ofNullable(createTranslationResponseJson)
     ...
     * import java.util.Optional;
     *
     * Optional<String> result = translationCreateResponse.accept(new TranslationCreateResponse.Visitor<Optional<String>>() {
     *     @Override
     *     public Optional<String> visitCreateTranslationResponseVerboseJson(CreateTranslationResponseVerboseJson createTranslationResponseVerboseJson) {
     *         return Optional.of(createTranslationResponseVerboseJson.toString());
     *     }
     *
     *     // ...
     *
