...
private constructor(
    private val createImageRequest: CreateImageRequest,
    private val additionalHeaders: Headers,
    private val additionalQueryParams: QueryParams,
) : Params {

    /** Request to generate images. */
    fun createImageRequest(): CreateImageRequest = createImageRequest

    fun _additionalBodyProperties(): Map<String, JsonValue> =
        createImageRequest._additionalProperties()
    ...
    class Builder internal constructor() {
        ...
        private var createImageRequest: CreateImageRequest? = null
        private var additionalHeaders: Headers.Builder = Headers.builder()
        private var additionalQueryParams: QueryParams.Builder = QueryParams.builder()

        @JvmSynthetic
        internal fun from(imageGenerateParams: ImageGenerateParams) = apply {
            createImageRequest = imageGenerateParams.createImageRequest
        ...
        /** Request to generate images. */
        fun createImageRequest(createImageRequest: CreateImageRequest) = apply {
            this.createImageRequest = createImageRequest
        }
        ...
        fun build(): ImageGenerateParams =
            ImageGenerateParams(
                checkRequired("createImageRequest", createImageRequest),
                additionalHeaders.build(),
                additionalQueryParams.build(),
            )
    }

    fun _body(): CreateImageRequest = createImageRequest
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ImageGenerateParams &&
            createImageRequest == other.createImageRequest &&
            additionalHeaders == other.additionalHeaders &&
            additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int =
        Objects.hash(createImageRequest, additionalHeaders, additionalQueryParams)

    override fun toString() =
        "ImageGenerateParams{createImageRequest=$createImageRequest, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
