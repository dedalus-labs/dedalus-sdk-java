...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        /** Alias for calling [Builder.mask] with `mask.orElse(null)`. */
        fun mask(mask: Optional<InputStream>) = mask(mask.getOrNull())
        ...
        /** Alias for calling [Builder.mask] with `mask.orElse(null)`. */
        fun mask(mask: Optional<ByteArray>) = mask(mask.getOrNull())

        fun mask(path: Path?) = apply { body.mask(path) }

        /** Alias for calling [mask] with `path.orElse(null)`. */
        fun mask(path: Optional<Path>) = mask(path.getOrNull())
    ...
    private constructor(
         ...
         *   server responded with an unexpected value).
         */
        fun model(): Optional<String> = model.value.getOptional("model")
         ...
         *   server responded with an unexpected value).
         */
        fun size(): Optional<String> = size.value.getOptional("size")
