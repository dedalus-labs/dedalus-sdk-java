 ...
 *
 * Translates audio files in any supported language to English text using OpenAI's Whisper model.
 * Supports the same audio formats as transcription. Maximum file size is 25 MB.
 *
 * Args: file: Audio file to translate (required) model: Model ID to use (e.g., "openai/whisper-1")
...
private constructor(
     ...
     *   server responded with an unexpected value).
     */
    fun responseFormat(): Optional<String> = body.responseFormat()
    ...
    class Builder internal constructor() {
        ...
        fun responseFormat(responseFormat: Optional<String>) =
    ...
    private constructor(
         ...
         *   server responded with an unexpected value).
         */
        fun responseFormat(): Optional<String> = responseFormat.value.getOptional("response_format")
        ...
        private val hashCode: Int by lazy {
            Objects.hash(file, model, prompt, responseFormat, temperature, additionalProperties)
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is TranslationCreateParams &&
            body == other.body &&
