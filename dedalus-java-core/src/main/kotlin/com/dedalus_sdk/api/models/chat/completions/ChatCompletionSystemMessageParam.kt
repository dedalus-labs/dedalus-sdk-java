 ...
 *
 * Fields:
 * - content (required): str | Annotated[list[ChatCompletionRequestSystemMessageContentPart],
...
private constructor(
    ...
    class Builder internal constructor() {
         ...
         * `Content.ofChatCompletionRequestSystemMessageContentArray(chatCompletionRequestSystemMessageContentArray)`.
         */
        fun contentOfChatCompletionRequestSystemMessageContentArray(
            chatCompletionRequestSystemMessageContentArray: List<ChatCompletionContentPartTextParam>
        ) =
            content(
                Content.ofChatCompletionRequestSystemMessageContentArray(
    ...
    private constructor(
        ...
        private val chatCompletionRequestSystemMessageContentArray:
        ...
        fun chatCompletionRequestSystemMessageContentArray():
            Optional<List<ChatCompletionContentPartTextParam>> =
            Optional.ofNullable(chatCompletionRequestSystemMessageContentArray)

        fun isString(): Boolean = string != null

        fun isChatCompletionRequestSystemMessageContentArray(): Boolean =
            chatCompletionRequestSystemMessageContentArray != null

        fun asString(): String = string.getOrThrow("string")

        fun asChatCompletionRequestSystemMessageContentArray():
            List<ChatCompletionContentPartTextParam> =
            chatCompletionRequestSystemMessageContentArray.getOrThrow(
                "chatCompletionRequestSystemMessageContentArray"
            )
        ...
        fun <T> accept(visitor: Visitor<T>): T =
            when {
                ...
                chatCompletionRequestSystemMessageContentArray != null ->
                    visitor.visitChatCompletionRequestSystemMessageContentArray(
                        chatCompletionRequestSystemMessageContentArray
                    )
        ...
        fun validate(): Content = apply {
            ...
            accept(
                object : Visitor<Unit> {
                    ...
                    override fun visitChatCompletionRequestSystemMessageContentArray(
                        chatCompletionRequestSystemMessageContentArray:
                            List<ChatCompletionContentPartTextParam>
                    ) {
                        chatCompletionRequestSystemMessageContentArray.forEach { it.validate() }
                    }
                }
            )
            validated = true
            ...
            accept(
                object : Visitor<Int> {
                    ...
                    override fun visitChatCompletionRequestSystemMessageContentArray(
                        ...
                        chatCompletionRequestSystemMessageContentArray.sumOf {
                            it.validity().toInt()
                        }
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return other is Content &&
                string == other.string &&
                chatCompletionRequestSystemMessageContentArray ==
                    other.chatCompletionRequestSystemMessageContentArray
        }

        override fun hashCode(): Int =
            Objects.hash(string, chatCompletionRequestSystemMessageContentArray)

        override fun toString(): String =
            when {
                string != null -> "Content{string=$string}"
                chatCompletionRequestSystemMessageContentArray != null ->
                    "Content{chatCompletionRequestSystemMessageContentArray=$chatCompletionRequestSystemMessageContentArray}"
        ...
        companion object {
            ...
            @JvmStatic
            fun ofChatCompletionRequestSystemMessageContentArray(
                chatCompletionRequestSystemMessageContentArray:
                    List<ChatCompletionContentPartTextParam>
            ) =
                Content(
                    chatCompletionRequestSystemMessageContentArray =
                        chatCompletionRequestSystemMessageContentArray.toImmutable()
                )
        }
        ...
        interface Visitor<out T> {
            ...
            fun visitChatCompletionRequestSystemMessageContentArray(
                chatCompletionRequestSystemMessageContentArray:
                    List<ChatCompletionContentPartTextParam>
            ): T
                ...
                val bestMatches =
                    sequenceOf(
                            ...
                            tryDeserialize(
                                ...
                                ?.let {
                                    Content(
                                        chatCompletionRequestSystemMessageContentArray = it,
                                        _json = json,
                                    )
                                },
                        )
        ...
        internal class Serializer : BaseSerializer<Content>(Content::class) {
            ...
            override fun serialize(
                ...
                when {
                    ...
                    value.chatCompletionRequestSystemMessageContentArray != null ->
                        generator.writeObject(value.chatCompletionRequestSystemMessageContentArray)
