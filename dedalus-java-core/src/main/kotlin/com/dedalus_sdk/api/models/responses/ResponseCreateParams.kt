...
private constructor(
    private val responseCreateParams: ResponseCreateParams,
    private val additionalHeaders: Headers,
    private val additionalQueryParams: QueryParams,
) : Params {

    /** Responses request schema with Dedalus extensions. */
    fun responseCreateParams(): ResponseCreateParams = responseCreateParams

    fun _additionalBodyProperties(): Map<String, JsonValue> =
        responseCreateParams._additionalProperties()
    ...
    class Builder internal constructor() {
        ...
        private var responseCreateParams: ResponseCreateParams? = null
        private var additionalHeaders: Headers.Builder = Headers.builder()
        private var additionalQueryParams: QueryParams.Builder = QueryParams.builder()

        @JvmSynthetic
        internal fun from(responseCreateParams: ResponseCreateParams) = apply {
            this.responseCreateParams = responseCreateParams.responseCreateParams
        ...
        /** Responses request schema with Dedalus extensions. */
        fun responseCreateParams(responseCreateParams: ResponseCreateParams) = apply {
        ...
        fun build(): ResponseCreateParams =
            ResponseCreateParams(
                checkRequired("responseCreateParams", responseCreateParams),
                additionalHeaders.build(),
                additionalQueryParams.build(),
            )
    }

    fun _body(): ResponseCreateParams = responseCreateParams
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ResponseCreateParams &&
            responseCreateParams == other.responseCreateParams &&
            additionalHeaders == other.additionalHeaders &&
            additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int =
        Objects.hash(responseCreateParams, additionalHeaders, additionalQueryParams)

    override fun toString() =
        "ResponseCreateParams{responseCreateParams=$responseCreateParams, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
