...
private constructor(
    ...
    private constructor(
        ...
        fun chatCompletionRequestUserMessageContentArray():
            Optional<List<UnnamedSchemaWithArrayParent2>> =
            Optional.ofNullable(chatCompletionRequestUserMessageContentArray)
        ...
        private constructor(
             ...
             * - text (required): str
             */
            fun text(): Optional<ChatCompletionContentPartTextParam> = Optional.ofNullable(text)
             ...
             */
            fun imageUrl(): Optional<ChatCompletionContentPartImageParam> =
             ...
             */
            fun inputAudio(): Optional<ChatCompletionContentPartInputAudioParam> =
             ...
             * - file (required): File
             */
            fun file(): Optional<ChatCompletionContentPartFileParam> = Optional.ofNullable(file)
             ...
             * import java.util.Optional;
             *
             * Optional<String> result = unnamedSchemaWithArrayParent2.accept(new UnnamedSchemaWithArrayParent2.Visitor<Optional<String>>() {
             *     @Override
             *     public Optional<String> visitText(ChatCompletionContentPartTextParam text) {
