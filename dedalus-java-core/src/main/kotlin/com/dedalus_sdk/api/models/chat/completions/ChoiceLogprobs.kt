...
private constructor(
     ...
     */
    fun content(): Optional<List<ChatCompletionTokenLogprob>> = content.getOptional("content")
     ...
     *   server responded with an unexpected value).
     */
    fun refusal(): Optional<List<ChatCompletionTokenLogprob>> = refusal.getOptional("refusal")
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [ChoiceLogprobs]. */
    ...
    class Builder internal constructor() {
        ...
        internal fun from(choiceLogprobs: ChoiceLogprobs) = apply {
            ...
            refusal = choiceLogprobs.refusal.map { it.toMutableList() }
            additionalProperties = choiceLogprobs.additionalProperties.toMutableMap()
        }
    ...
    override fun toString() =
        "ChoiceLogprobs{content=$content, refusal=$refusal, additionalProperties=$additionalProperties}"
}
