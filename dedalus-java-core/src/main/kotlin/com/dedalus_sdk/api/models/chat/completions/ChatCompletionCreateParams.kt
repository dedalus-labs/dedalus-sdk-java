...
private constructor(
     ...
     */
    fun agentAttributes(): Optional<AgentAttributes> =
        agentAttributes.getOptional("agent_attributes")
     ...
     *   server responded with an unexpected value).
     */
    fun automaticToolExecution(): Optional<Boolean> =
        automaticToolExecution.getOptional("automatic_tool_execution")
     ...
     *   server responded with an unexpected value).
     */
    fun cachedContent(): Optional<String> = cachedContent.getOptional("cached_content")
     ...
     *   server responded with an unexpected value).
     */
    fun deferredCalls(): Optional<List<DeferredCallResponse>> =
        deferredCalls.getOptional("deferred_calls")
     ...
     *   server responded with an unexpected value).
     */
    fun functionCall(): Optional<String> = functionCall.getOptional("function_call")
     ...
     *   server responded with an unexpected value).
     */
    fun functions(): Optional<List<ChatCompletionFunctions>> = functions.getOptional("functions")
     ...
     *   server responded with an unexpected value).
     */
    fun guardrails(): Optional<List<Guardrail>> = guardrails.getOptional("guardrails")
     ...
     *   server responded with an unexpected value).
     */
    fun handoffConfig(): Optional<HandoffConfig> = handoffConfig.getOptional("handoff_config")
     ...
     *   server responded with an unexpected value).
     */
    fun handoffMode(): Optional<Boolean> = handoffMode.getOptional("handoff_mode")
     ...
     *   server responded with an unexpected value).
     */
    fun maxTurns(): Optional<Long> = maxTurns.getOptional("max_turns")
     ...
     *   server responded with an unexpected value).
     */
    fun mcpServers(): Optional<McpServers> = mcpServers.getOptional("mcp_servers")
     ...
     *   server responded with an unexpected value).
     */
    fun metadata(): Optional<JsonObjectInput> = metadata.getOptional("metadata")
     ...
     *   server responded with an unexpected value).
     */
    fun modelAttributes(): Optional<ModelAttributes> =
        modelAttributes.getOptional("model_attributes")
     ...
     *   server responded with an unexpected value).
     */
    fun outputConfig(): Optional<JsonObjectInput> = outputConfig.getOptional("output_config")
     ...
     *   server responded with an unexpected value).
     */
    fun prediction(): Optional<PredictionContent> = prediction.getOptional("prediction")
     ...
     *   server responded with an unexpected value).
     */
    fun promptCacheRetention(): Optional<String> =
     ...
     *   server responded with an unexpected value).
     */
    fun promptMode(): Optional<PromptMode> = promptMode.getOptional("prompt_mode")
     ...
     *   server responded with an unexpected value).
     */
    fun safePrompt(): Optional<Boolean> = safePrompt.getOptional("safe_prompt")
     ...
     *   server responded with an unexpected value).
     */
    fun safetySettings(): Optional<List<SafetySetting>> =
     ...
     *   server responded with an unexpected value).
     */
    fun systemInstruction(): Optional<SystemInstruction> =
     ...
     *   server responded with an unexpected value).
     */
    fun tools(): Optional<List<ChatCompletionToolParam>> = tools.getOptional("tools")
    ...
    class Builder internal constructor() {
        ...
        /** Alias for calling [Builder.agentAttributes] with `agentAttributes.orElse(null)`. */
        fun agentAttributes(agentAttributes: Optional<AgentAttributes>) =
            agentAttributes(agentAttributes.getOrNull())
        ...
        /** Alias for calling [Builder.cachedContent] with `cachedContent.orElse(null)`. */
        fun cachedContent(cachedContent: Optional<String>) =
        ...
        /** Alias for calling [Builder.deferredCalls] with `deferredCalls.orElse(null)`. */
        fun deferredCalls(deferredCalls: Optional<List<DeferredCallResponse>>) =
            deferredCalls(deferredCalls.getOrNull())
        ...
        fun functionCall(functionCall: Optional<String>) = functionCall(functionCall.getOrNull())
        ...
        fun functions(functions: Optional<List<ChatCompletionFunctions>>) =
            functions(functions.getOrNull())
        ...
        fun guardrails(guardrails: Optional<List<Guardrail>>) = guardrails(guardrails.getOrNull())
        ...
        /** Alias for calling [Builder.handoffConfig] with `handoffConfig.orElse(null)`. */
        fun handoffConfig(handoffConfig: Optional<HandoffConfig>) =
            handoffConfig(handoffConfig.getOrNull())
        ...
        /** Alias for calling [Builder.handoffMode] with `handoffMode.orElse(null)`. */
        fun handoffMode(handoffMode: Optional<Boolean>) = handoffMode(handoffMode.getOrNull())
        ...
        /** Alias for calling [Builder.maxTurns] with `maxTurns.orElse(null)`. */
        fun maxTurns(maxTurns: Optional<Long>) = maxTurns(maxTurns.getOrNull())
        ...
        fun mcpServers(mcpServers: Optional<McpServers>) = mcpServers(mcpServers.getOrNull())
        ...
        fun metadata(metadata: Optional<JsonObjectInput>) = metadata(metadata.getOrNull())
        ...
        /** Alias for calling [Builder.modelAttributes] with `modelAttributes.orElse(null)`. */
        fun modelAttributes(modelAttributes: Optional<ModelAttributes>) =
            modelAttributes(modelAttributes.getOrNull())
        ...
        fun outputConfig(outputConfig: Optional<JsonObjectInput>) =
        ...
        fun prediction(prediction: Optional<PredictionContent>) = prediction(prediction.getOrNull())
         ...
         */
        fun promptCacheRetention(promptCacheRetention: Optional<String>) =
        ...
        /** Alias for calling [Builder.promptMode] with `promptMode.orElse(null)`. */
        fun promptMode(promptMode: Optional<PromptMode>) = promptMode(promptMode.getOrNull())
        ...
        /** Alias for calling [Builder.safePrompt] with `safePrompt.orElse(null)`. */
        fun safePrompt(safePrompt: Optional<Boolean>) = safePrompt(safePrompt.getOrNull())
        ...
        fun safetySettings(safetySettings: Optional<List<SafetySetting>>) =
        ...
        fun systemInstruction(systemInstruction: Optional<SystemInstruction>) =
        ...
        fun tools(tools: Optional<List<ChatCompletionToolParam>>) = tools(tools.getOrNull())
    ...
    fun validate(): ChatCompletionCreateParams = apply {
        ...
        model().validate()
        agentAttributes().ifPresent { it.validate() }
        ...
        deferred()
        deferredCalls().ifPresent { it.forEach { it.validate() } }
        frequencyPenalty()
        functionCall()
        functions().ifPresent { it.forEach { it.validate() } }
        generationConfig().ifPresent { it.validate() }
        guardrails().ifPresent { it.forEach { it.validate() } }
        handoffConfig().ifPresent { it.validate() }
        handoffMode()
        inferenceGeo()
        ...
        maxTokens()
        maxTurns()
        mcpServers().ifPresent { it.validate() }
        messages().ifPresent { it.forEach { it.validate() } }
        metadata().ifPresent { it.validate() }
        modalities()
        modelAttributes().ifPresent { it.validate() }
        n()
        ...
        promptCacheKey()
        promptCacheRetention()
        promptMode().ifPresent { it.validate() }
        reasoningEffort()
    ...
    internal fun validity(): Int =
        (model.asKnown().getOrNull()?.validity() ?: 0) +
            (agentAttributes.asKnown().getOrNull()?.validity() ?: 0) +
            (audio.asKnown().getOrNull()?.validity() ?: 0) +
            (if (automaticToolExecution.asKnown().isPresent) 1 else 0) +
            (if (cachedContent.asKnown().isPresent) 1 else 0) +
            ...
            (deferredCalls.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) +
            (if (frequencyPenalty.asKnown().isPresent) 1 else 0) +
            (if (functionCall.asKnown().isPresent) 1 else 0) +
            ...
            (handoffConfig.asKnown().getOrNull()?.validity() ?: 0) +
            (if (handoffMode.asKnown().isPresent) 1 else 0) +
            ...
            (mcpServers.asKnown().getOrNull()?.validity() ?: 0) +
            (messages.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) +
            (metadata.asKnown().getOrNull()?.validity() ?: 0) +
            (modalities.asKnown().getOrNull()?.size ?: 0) +
            (modelAttributes.asKnown().getOrNull()?.validity() ?: 0) +
            ...
            (if (promptCacheRetention.asKnown().isPresent) 1 else 0) +
            (promptMode.asKnown().getOrNull()?.validity() ?: 0) +
            (if (reasoningEffort.asKnown().isPresent) 1 else 0) +
            (responseFormat.asKnown().getOrNull()?.validity() ?: 0) +
            (if (safePrompt.asKnown().isPresent) 1 else 0) +
    ...
    private constructor(
         ...
         */
        fun dedalus(): Optional<DedalusModel> = Optional.ofNullable(dedalus)

        fun dedalusModelChoices(): Optional<List<DedalusModelChoice>> =
            Optional.ofNullable(dedalusModelChoices)
         ...
         *     @Override
         *     public Optional<String> visitModelId(String modelId) {
        ...
        companion object {
            ...
            /** Model identifier string (e.g., 'openai/gpt-5', 'anthropic/claude-3-5-sonnet'). */
            @JvmStatic fun ofModelId(modelId: String) = Model(modelId = modelId)
             ...
             * default settings for Dedalus multi-model routing.
             */
            @JvmStatic fun ofDedalus(dedalus: DedalusModel) = Model(dedalus = dedalus)
    ...
    private constructor(
         ...
         */
        fun credential(): Optional<Credential> = Optional.ofNullable(credential)

        /** List of credentials for MCP server authentication. */
        fun mcpCredentials(): Optional<List<Credential>> = Optional.ofNullable(mcpCredentials)
         ...
         * import java.util.Optional;
         *
         * Optional<String> result = credentials.accept(new Credentials.Visitor<Optional<String>>() {
         *     @Override
         *     public Optional<String> visitCredential(Credential credential) {
         *         return Optional.of(credential.toString());
         *     }
         *
         *     // ...
         *
    ...
    private constructor(
         ...
         * "name": "custom-server"}
         */
        fun serverSpec(): Optional<McpServerSpec> = Optional.ofNullable(serverSpec)

        /** List of MCP server inputs (slugs or structured specs). */
        fun mcpServers(): Optional<List<UnnamedSchemaWithArrayParent0>> =
            Optional.ofNullable(mcpServers)
         ...
         * import java.util.Optional;
         *
         * Optional<String> result = mcpServers.accept(new McpServers.Visitor<Optional<String>>() {
         *     @Override
        ...
        companion object {
            ...
            @JvmStatic fun ofString(string: String) = McpServers(string = string)
        ...
        private constructor(
             ...
             * "https://mcp.dedaluslabs.ai/acme/my-server/mcp", "name": "custom-server"}
             */
            fun mcpServerSpec(): Optional<McpServerSpec> = Optional.ofNullable(mcpServerSpec)
             ...
             * import java.util.Optional;
             *
             * Optional<String> result = unnamedSchemaWithArrayParent0.accept(new UnnamedSchemaWithArrayParent0.Visitor<Optional<String>>() {
             *     @Override
             *     public Optional<String> visitString(String string) {
             *         return Optional.of(string.toString());
             *     }
    ...
    private constructor(
         ...
         * - name (optional): str
         */
        fun developer(): Optional<ChatCompletionDeveloperMessageParam> =
            Optional.ofNullable(developer)
         ...
         */
        fun assistant(): Optional<ChatCompletionAssistantMessageParam> =
            Optional.ofNullable(assistant)
         ...
         *     @Override
         *     public Optional<String> visitDeveloper(ChatCompletionDeveloperMessageParam developer) {
        ...
        companion object {
             ...
             * - name (optional): str
             */
            @JvmStatic fun ofUser(user: ChatCompletionUserMessageParam) = Message(user = user)
             ...
             * - tool_call_id (required): str
             */
            @JvmStatic fun ofTool(tool: ChatCompletionToolMessageParam) = Message(tool = tool)
    ...
    class PromptMode @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val REASONING = of("reasoning")

            @JvmStatic fun of(value: String) = PromptMode(JsonField.of(value))
        }
    ...
    private constructor(
        ...
        class Category @JsonCreator private constructor(private val value: JsonField<String>) :
            ...
            companion object {
                ...
                @JvmField val HARM_CATEGORY_UNSPECIFIED = of("HARM_CATEGORY_UNSPECIFIED")

                @JvmField val HARM_CATEGORY_DEROGATORY = of("HARM_CATEGORY_DEROGATORY")

                @JvmField val HARM_CATEGORY_TOXICITY = of("HARM_CATEGORY_TOXICITY")

                @JvmField val HARM_CATEGORY_VIOLENCE = of("HARM_CATEGORY_VIOLENCE")

                @JvmField val HARM_CATEGORY_SEXUAL = of("HARM_CATEGORY_SEXUAL")

                @JvmField val HARM_CATEGORY_MEDICAL = of("HARM_CATEGORY_MEDICAL")

                @JvmField val HARM_CATEGORY_DANGEROUS = of("HARM_CATEGORY_DANGEROUS")

                @JvmField val HARM_CATEGORY_HARASSMENT = of("HARM_CATEGORY_HARASSMENT")

                @JvmField val HARM_CATEGORY_HATE_SPEECH = of("HARM_CATEGORY_HATE_SPEECH")
                ...
                @JvmField val HARM_CATEGORY_CIVIC_INTEGRITY = of("HARM_CATEGORY_CIVIC_INTEGRITY")
            ...
            fun asString(): String =
                _value().asString().orElseThrow {
                    DedalusInvalidDataException("Value is not a String")
                }
        ...
        class Threshold @JsonCreator private constructor(private val value: JsonField<String>) :
            ...
            companion object {
                ...
                @JvmField val BLOCK_LOW_AND_ABOVE = of("BLOCK_LOW_AND_ABOVE")

                @JvmField val BLOCK_MEDIUM_AND_ABOVE = of("BLOCK_MEDIUM_AND_ABOVE")

                @JvmField val BLOCK_ONLY_HIGH = of("BLOCK_ONLY_HIGH")

                @JvmField val BLOCK_NONE = of("BLOCK_NONE")

                @JvmField val OFF = of("OFF")

                @JvmStatic fun of(value: String) = Threshold(JsonField.of(value))
            }
    ...
    private constructor(
        ...
        fun jsonObjectInput(): Optional<JsonObjectInput> = Optional.ofNullable(jsonObjectInput)
         ...
         * import java.util.Optional;
         *
         * Optional<String> result = systemInstruction.accept(new SystemInstruction.Visitor<Optional<String>>() {
         *     @Override
         *     public Optional<String> visitJsonObjectInput(JsonObjectInput jsonObjectInput) {
         *         return Optional.of(jsonObjectInput.toString());
         *     }
         *
         *     // ...
         *
        ...
        companion object {
            ...
            @JvmStatic fun ofString(string: String) = SystemInstruction(string = string)
        }
    ...
    private constructor(
         ...
         */
        fun adaptive(): Optional<JsonValue> = Optional.ofNullable(adaptive)
        ...
        companion object {
             ...
             * - type (required): Literal["enabled"]
             */
            @JvmStatic fun ofEnabled(enabled: ThinkingConfigEnabled) = Thinking(enabled = enabled)
