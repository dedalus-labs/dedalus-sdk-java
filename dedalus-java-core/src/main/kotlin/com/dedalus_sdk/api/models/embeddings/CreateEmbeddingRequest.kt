...
private constructor(
     ...
     *   server responded with an unexpected value).
     */
    fun encodingFormat(): Optional<EncodingFormat> = encodingFormat.getOptional("encoding_format")
    ...
    private constructor(
        ...
        fun embeddingRequestInputArray(): Optional<List<String>> =
            Optional.ofNullable(embeddingRequestInputArray)

        fun embeddingRequestInputArray(): Optional<List<Long>> =
            Optional.ofNullable(embeddingRequestInputArray)

        fun embeddingRequestInputArray(): Optional<List<List<Long>>> =
            Optional.ofNullable(embeddingRequestInputArray)
