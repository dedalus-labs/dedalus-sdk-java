...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(listModelsResponse: ListModelsResponse) = apply {
            ...
            object_ = listModelsResponse.object_
        ...
        /**
         * Returns an immutable instance of [ListModelsResponse].
         *
    ...
    override fun toString() =
        "ListModelsResponse{data=$data, object_=$object_, additionalProperties=$additionalProperties}"
}
