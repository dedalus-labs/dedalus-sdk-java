...
private constructor(
     ...
     */
    fun thoughtSignature(): Optional<String> = thoughtSignature.getOptional("thought_signature")
    ...
    class Builder internal constructor() {
        ...
        /** Alias for calling [Builder.thoughtSignature] with `thoughtSignature.orElse(null)`. */
        fun thoughtSignature(thoughtSignature: Optional<String>) =
    ...
    internal fun validity(): Int =
        (if (id.asKnown().isPresent) 1 else 0) +
            ...
            (if (thoughtSignature.asKnown().isPresent) 1 else 0)
