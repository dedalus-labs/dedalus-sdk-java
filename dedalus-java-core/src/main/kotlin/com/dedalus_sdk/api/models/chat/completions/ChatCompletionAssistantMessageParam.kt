...
private constructor(
    ...
    private constructor(
        ...
        fun chatCompletionRequestAssistantMessageContentArray():
            ...
            Optional.ofNullable(chatCompletionRequestAssistantMessageContentArray)
        ...
        private constructor(
             ...
             */
            fun refusal(): Optional<ChatCompletionContentPartRefusalParam> =
             ...
             * import java.util.Optional;
             *
             * Optional<String> result = unnamedSchemaWithArrayParent1.accept(new UnnamedSchemaWithArrayParent1.Visitor<Optional<String>>() {
             *     @Override
    ...
    private constructor(
         ...
         * - thought_signature (optional): str
         */
        fun function(): Optional<ChatCompletionMessageToolCall> = Optional.ofNullable(function)
         ...
         * import java.util.Optional;
         *
         * Optional<String> result = toolCall.accept(new ToolCall.Visitor<Optional<String>>() {
         *     @Override
         *     public Optional<String> visitFunction(ChatCompletionMessageToolCall function) {
