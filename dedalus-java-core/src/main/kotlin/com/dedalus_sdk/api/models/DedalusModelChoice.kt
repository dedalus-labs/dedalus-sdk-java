...
private constructor(
     ...
     */
    fun dedalusModel(): Optional<DedalusModel> = Optional.ofNullable(dedalusModel)
     ...
     * import java.util.Optional;
     *
     * Optional<String> result = dedalusModelChoice.accept(new DedalusModelChoice.Visitor<Optional<String>>() {
     *     @Override
    ...
    companion object {
        ...
        /** Model identifier string (e.g., 'openai/gpt-5', 'anthropic/claude-3-5-sonnet'). */
        @JvmStatic fun ofModelId(modelId: String) = DedalusModelChoice(modelId = modelId)
