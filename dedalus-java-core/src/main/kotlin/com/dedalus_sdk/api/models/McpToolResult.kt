...
private constructor(
     ...
     *   server responded with an unexpected value).
     */
    fun result(): Optional<JsonValueInput> = result.getOptional("result")
    ...
    class Builder internal constructor() {
        ...
        fun result(result: Optional<JsonValueInput>) = result(result.getOrNull())
        ...
        /** Alias for calling [result] with `JsonValueInput.ofNumber(number)`. */
        fun result(number: Double) = result(JsonValueInput.ofNumber(number))

        /** Alias for calling [result] with `JsonValueInput.ofBool(bool)`. */
        fun result(bool: Boolean) = result(JsonValueInput.ofBool(bool))
