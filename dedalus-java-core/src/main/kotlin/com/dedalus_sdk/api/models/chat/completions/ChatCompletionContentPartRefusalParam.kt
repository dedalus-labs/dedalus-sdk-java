...
private constructor(
    ...
    /** A builder for [ChatCompletionContentPartRefusalParam]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            refusal = chatCompletionContentPartRefusalParam.refusal
            type = chatCompletionContentPartRefusalParam.type
            additionalProperties =
                chatCompletionContentPartRefusalParam.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ChatCompletionContentPartRefusalParam].
         *
         ...
         */
        fun build(): ChatCompletionContentPartRefusalParam =
            ChatCompletionContentPartRefusalParam(
     ...
     *   expected type.
     */
    fun validate(): ChatCompletionContentPartRefusalParam = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ChatCompletionContentPartRefusalParam &&
    ...
    override fun toString() =
        "ChatCompletionContentPartRefusalParam{refusal=$refusal, type=$type, additionalProperties=$additionalProperties}"
}
