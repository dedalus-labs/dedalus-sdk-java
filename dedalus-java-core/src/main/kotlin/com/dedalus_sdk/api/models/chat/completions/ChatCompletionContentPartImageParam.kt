...
private constructor(
    ...
    /** A builder for [ChatCompletionContentPartImageParam]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            type = chatCompletionContentPartImageParam.type
            additionalProperties =
                chatCompletionContentPartImageParam.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ChatCompletionContentPartImageParam].
         *
         ...
         */
        fun build(): ChatCompletionContentPartImageParam =
            ChatCompletionContentPartImageParam(
     ...
     *   expected type.
     */
    fun validate(): ChatCompletionContentPartImageParam = apply {
        if (validated) {
            return@apply
        }
        ...
        class Detail @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
            ...
            fun known(): Known =
                when (this) {
                    ...
                    LOW -> Known.LOW
                    HIGH -> Known.HIGH
                    else -> throw DedalusInvalidDataException("Unknown Detail: $value")
                }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ChatCompletionContentPartImageParam &&
    ...
    override fun toString() =
        "ChatCompletionContentPartImageParam{imageUrl=$imageUrl, type=$type, additionalProperties=$additionalProperties}"
}
