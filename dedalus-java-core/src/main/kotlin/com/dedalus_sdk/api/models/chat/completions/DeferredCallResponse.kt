...
private constructor(
     ...
     */
    fun arguments(): Optional<JsonObjectInput> = arguments.getOptional("arguments")
     ...
     *   server responded with an unexpected value).
     */
    fun blockedBy(): Optional<List<String>> = blockedBy.getOptional("blocked_by")
    ...
    internal fun validity(): Int =
        (if (id.asKnown().isPresent) 1 else 0) +
            ...
            (blockedBy.asKnown().getOrNull()?.size ?: 0) +
