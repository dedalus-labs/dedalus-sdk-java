...
package com.dedalus_sdk.api.client.okhttp

import com.dedalus_sdk.api.client.DedalusClientAsync
import com.dedalus_sdk.api.client.DedalusClientAsyncImpl
import com.dedalus_sdk.api.core.ClientOptions
import com.dedalus_sdk.api.core.LogLevel
import com.dedalus_sdk.api.core.Sleeper
import com.dedalus_sdk.api.core.Timeout
...
class DedalusOkHttpClientAsync private constructor() {
    ...
    class Builder internal constructor() {
        ...
        fun development() = apply { clientOptions.development() }
         ...
         */
        fun asBaseUrl(asBaseUrl: String?) = apply { clientOptions.asBaseUrl(asBaseUrl) }
        ...
        fun provider(provider: String?) = apply { clientOptions.provider(provider) }
        ...
        fun providerKey(providerKey: String?) = apply { clientOptions.providerKey(providerKey) }
        ...
        fun providerModel(providerModel: String?) = apply {
            clientOptions.providerModel(providerModel)
        }
